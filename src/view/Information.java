...
//        jlbFeed.setBackground(new Color(255, 255, 255));
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Trung tâm bảo trợ trẻ em Việt-Nhật được thành lập vào ngày 30 tháng 4 năm 2019, dưới sự hợp tác và hỗ trợ nhiệt ");
        jpnMain.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 240, 950, 20));

        jLabel12.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel12.setText("tình của chính phủ Việt Nam và Nhật Bản. Trung tâm ra đời mang trong mình sứ mệnh cưu mang và giúp đỡ cho ");
        jpnMain.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 270, 940, -1));

        jLabel13.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel13.setText("những trẻ em mồ côi, không nơi nương tựa, phần nào đó bù đắp những tổn thương, mất mát mà các em đã phải ");
        jpnMain.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 300, 930, -1));

        jLabel14.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel14.setText(" lực to lớn để trung tâm ngày một phát triển hơn.");
        jpnMain.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 480, 970, -1));
        ...
        jLabel15.setText("chịu đựng. Trên tinh thần đó, trong suốt những năm hoạt động, trung tâm đã tiếp nhiều trẻ em mồ côi, không nơi ");
        jpnMain.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 330, 940, -1));

        jLabel16.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel16.setText(" nương tựa, cho các em một gia đình mới, nơi các em có những người bạn, những người anh em, nơi các em được ");
        jpnMain.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 360, 940, -1));

        jLabel17.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel17.setText("đến trường, được vui chơi như các bạn đồng trang lứa. Trung tâm vẫn đang nỗ lực từng ngày để giúp đỡ được nhiều ");
        jpnMain.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 390, 970, -1));

        jLabel20.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel20.setText("em nhỏ hơn cũng như nâng cao đời sống cho các em, trong nỗ lực đó không thể thiếu sự đồng hành và giúp đỡ của ");
        jpnMain.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 420, 990, -1));

        jLabel21.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel21.setText("các mạnh thường quân cũng như sự chung tay giúp đỡ của tất cả mọi người, mỗi một sự ủng hộ của quý vị là động ");
        jpnMain.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 450, 970, -1));
